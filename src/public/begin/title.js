...
export default function Application(){
    ...
    return(
        <>
                <Begin title={"Donnez un nom à votre logement"} onNext={()=>navigate('/begin/description')}  onPrev={()=>navigate(-1)} topBar={true} bottomBar={true} progressPercentage={(step / maxStep)*100}>
                    <div className='flex flex-col justify-center px-44 py-10 animate-showin w-full h-full overflow-y-auto'>
                        ...
                        <div>
                            <textarea onChange={handleChange} className="animation duration-200 px-5 py-4 border-none rounded-xl focus:outline-none ring-gray-400 ring-1 focus:ring-2 focus:ring-black focus:outline-transparent w-full font-medium text-3xl text-gray-800 h-40" value={title}></textarea>
